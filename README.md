...
```
###### Dom Projection (noun): The calculation of an element's position, size, and transform on a web page in relation to another element elsewhere in the DOM hierarchy.
